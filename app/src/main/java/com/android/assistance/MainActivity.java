package com.android.assistance;
...
import com.android.assistance.recognizer.DataFiles;
import com.android.assistance.recognizer.Grammar;
import com.android.assistance.recognizer.PhonMapper;
import com.android.assistance.vera.Controller;
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        Toast.makeText(MainActivity.this, "I am listening", Toast.LENGTH_SHORT).show();
                        startStopRecognition();
                        break;
                    case MotionEvent.ACTION_UP:
                        stopRecognition();
                        Toast.makeText(MainActivity.this, "I stop listen", Toast.LENGTH_SHORT).show();
                        break;
                }
                return true;
            }
